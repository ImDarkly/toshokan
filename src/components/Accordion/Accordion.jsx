...
const Accordion = ({ status }) => {
    ...
    return (
        <UseAccordion variant="splitted" className="px-0 gap-1 p-4">
            {orders
                ...
                .map((order) => {
                    ...
                    return (
                        <AccordionItem
                            ...
                            startContent={
                                ...
                                >
                                    <Button
                                        ...
                                        onClick={() =>
                                            copyTitle(order.title, order.id)
                                        }
                                        isIconOnly
                                        color="default"
                                        variant="light"
                            ...
                            className="
                                group-[.is-splitted]:rounded 
                                group-[.is-splitted]:shadow-none 
                                group-[.is-splitted]:bg-slate-100 
                                group-[.is-splitted]:first:rounded-t-2xl 
                                group-[.is-splitted]:last:rounded-b-2xl"
                            classNames={{
